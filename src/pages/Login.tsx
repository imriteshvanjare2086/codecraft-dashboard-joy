...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      ...
      >
        <div>
          <h1 className="text-xl font-heading font-semibold text-foreground">Login</h1>
          <p className="text-xs font-mono text-muted-foreground mt-1">Sign in to your CodeTrack account</p>
        </div>
